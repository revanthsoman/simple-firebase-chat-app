...
//            sp.getString("email",null);
            ...
            UserList.user = new ChatUser(FirebaseAuth.getInstance().getCurrentUser().getUid(), FirebaseAuth.getInstance().getCurrentUser().getDisplayName(), FirebaseAuth.getInstance().getCurrentUser().getEmail(), true, room);
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                //Shared Preferences to stay logged in
//                            SharedPreferences sp = getSharedPreferences("pref", MODE_PRIVATE);
