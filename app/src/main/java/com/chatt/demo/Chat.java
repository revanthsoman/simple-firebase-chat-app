...
public class Chat extends CustomActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.tb_include);
        ...
        getSupportActionBar().setTitle(buddy.getUsername());
...
//    }
    ...
    private void updateUserStatus(boolean online) {
        ...
        UserList.user.setOnline(online);
        FirebaseDatabase.getInstance().getReference("users").child(UserList.user.getId()).setValue(UserList.user);
    }
